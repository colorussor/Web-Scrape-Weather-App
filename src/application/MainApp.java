...
public class MainApp extends Application implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if (daytwoc.contains("Partly Cloudy") || daytwoc.contains("Mostly Cloudy") || daytwoc.equals("Fair")
				|| daytwoc.equals("Mostly Clear")) {
			daytwoimage.setImage(partcloudy);
		}
		if (daythreec.contains("Partly Cloudy") || daythreec.contains("Mostly Cloudy") || daythreec.equals("Fair")
				|| daythreec.equals("Mostly Clear")) {
			daythreeimage.setImage(partcloudy);
		}
		if (dayfourc.contains("Partly Cloudy") || dayfourc.contains("Mostly Cloudy") || dayfourc.equals("Fair")
				|| dayfourc.equals("Mostly Clear")) {
			dayfourimage.setImage(partcloudy);
		}
		if (dayfivec.contains("Partly Cloudy") || dayfivec.contains("Mostly Cloudy") || dayfivec.equals("Fair")
				|| dayfivec.equals("Mostly Clear")) {
